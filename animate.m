...
while SIM_TIME < t(end);
    ...
    axesPos = get(findall(fig,'type','axes'),'position');
    text(0.02, axesPos(1) + axesPos(4),strcat('x',num2str(P.speed)), 'Units','normalized','FontSize',14,'FontWeight','bold');
    drawnow;
    pause(0.005);  
